     ...
     borderSide: BorderSide(width: 1,color: Color.fromARGB(255, 217, 217, 217)),
        ...
        RichText(text: TextSpan(
          ...
          TextSpan(
            ...
            text: 'Sign Up',
            style: const TextStyle(color:Color.fromARGB(255, 50, 134, 252),
        ...
        textAlign: TextAlign.center,
        overflow: TextOverflow.ellipsis,
        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Color.fromARGB(255, 57, 57, 57)),
        ),
        const SizedBox(height: 20),
        ElevatedButton.icon(style: ElevatedButton.styleFrom(minimumSize: const Size.fromHeight(60),
        shape: RoundedRectangleBorder(
        ...
        style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 57, 57, 57))),
        ),
        SizedBox(height: 40),
        ElevatedButton.icon(style: ElevatedButton.styleFrom(minimumSize: const Size.fromHeight(60),
        shape: RoundedRectangleBorder(
