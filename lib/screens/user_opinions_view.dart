...
import 'package:nomadly_app/models/UserOpinion.dart';
import 'package:nomadly_app/screens/review_card.dart';
import 'package:nomadly_app/screens/user_opinion_card.dart';
...
class UserOpinionsScreen extends StatefulWidget {
  ...
  UserOpinionsScreen({super.key, required this.userId,required this.user, required this.booking});
          ...
          children: [
            Row(
              ...
              children: [
                ...
                RatingBarIndicator(
                  rating: widget.user.rate!.toDouble(),
                      ...
                      itemBuilder: (context, index) {
                        return StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snap) {
                              ...
                              UserOpinion opinion = UserOpinion.fromJson(
                                  snapshot.data!.docs[index].data()
                                      as Map<String, dynamic>);

                              return UserOpinionCard(
                                user: user,
                                opinon: opinion,
                              );
                            });
